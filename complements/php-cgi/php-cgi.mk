...
$(PHPSOURCE)/php-5.5.16/Makefile: $(PHPSOURCE)/php-5.5.16/extract.ok
	cd $(PHPSOURCE)/php-5.5.16 ; ./configure --prefix=/usr/local/php --disable-all --enable-session --enable-pdo --with-sqlite3 --with-pdo-sqlite --with-pdo-mysql --enable-json ; touch $(PHPSOURCE)/php-5.5.16/Makefile
