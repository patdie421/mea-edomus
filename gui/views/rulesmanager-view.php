...
jQuery(document).ready(function() {
   ...
   ctrlr_rulesManager = new RulesManagerController("files_to_sel_rm", "files_sel_rm", "builded_rules_rm", "button_in_rm", "button_out_rm", "button_up_rm", "button_down_rm", "button_build_rm", "rulemgrmenu");
   ...
   buildrules_rm = ctrlr_rulesManager.build_rules.bind(ctrlr_rulesManager);
         ...
         <div style="width:100%;text-align:center;">
            ...
            <div id="rm" class="easyui-panel" data-options="style:{margin:'0 auto'}" title="<?php mea_toLocalC_2d('choose builded rules to apply'); ?>" style="width:700px;padding:10px;">
               <table width="600px" align="center" style="padding-bottom: 12px;">
                  ...
                  <tr>
                     <td align="center">
                        <select name="builded_rules_rm" id="builded_rules_rm" size="15" style="width:40%;font-family:verdana,helvetica,arial,sans-serif;font-size:12px;">
                        </select>
                     </td>
                  </tr>
               </table>
