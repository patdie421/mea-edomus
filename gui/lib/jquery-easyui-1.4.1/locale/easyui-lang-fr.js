if ($.fn.pagination){
	...
	$.fn.pagination.defaults.displayMsg = 'Affichage de {from} à {to} sur un total de {total}';
}
if ($.fn.datagrid){
	$.fn.datagrid.defaults.loadMsg = "Traitement, patientez s'il vous plaît ...";
}
...
if ($.fn.calendar){
	...
	$.fn.calendar.defaults.months = ['Jan', 'Feb', 'Mar', 'Avr', 'Mai', 'Jui', 'Jul', 'Aou', 'Sep', 'Oct', 'Nov', 'Dec'];
}
if ($.fn.datebox){
