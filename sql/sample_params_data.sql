...
INSERT INTO "types" VALUES(2,200,'INTYP02','Interface de type 02','');
...
INSERT INTO "types" VALUES(5,1001,'ARDINA','Entree interface type 01','');
INSERT INTO "types" VALUES(6,1002,'ARDOUTD','Sortie interface type 02','');
...
INSERT INTO "sensors_actuators" VALUES(1,1,1002,1,'R1','Commande telerupteur SALLE1',20,'PIN=AI0;MODE=DIGITAL;ACTION=PULSE',1);
INSERT INTO "sensors_actuators" VALUES(2,2,1001,1,'TEMP01','Temperature du capteur TMP36',10,'PIN=AI3;MODE=ANALOG;COMPUTE=TEMP;ALGO=TMP36',1);
...
INSERT INTO "sensors_actuators" VALUES(10,9,201,3,'R2','RELAI XBEE D1',10,'PLUGIN=vmc;PARAMETERS=D1:4',1);
INSERT INTO "sensors_actuators" VALUES(11,10,201,3,'I1','ENTREE A2 XBEE',10,'PLUGIN=xbee_generic;PARAMETERS=PIN:A2',1);
INSERT INTO "sensors_actuators" VALUES(12,11,201,3,'I2','ENTREE D3 XBEE',10,'PLUGIN=xbee_generic;PARAMETERS=PIN:D3',1);
INSERT INTO "sensors_actuators" VALUES(13,11,1000,1,'CNTR0','COMPTEUR PROD',10,'COUNTER=0',1);
